...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { cut_code: @coupon.cut_code, enabled: @coupon.enabled, event_id: @coupon.event_id }
    end
  ...
  test "should update coupon" do
    patch :update, id: @coupon, coupon: { cut_code: @coupon.cut_code, enabled: @coupon.enabled, event_id: @coupon.event_id }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
